...
ca_db_local_gov <- ca_local_gov %>% 
  filter(str_detect(naics_description, "DATA") |
           ...
           str_detect(prime_award_base_transaction_description, "LAW ENFORCEMENT TELECOMMUNICATIONS SYSTEM"))
